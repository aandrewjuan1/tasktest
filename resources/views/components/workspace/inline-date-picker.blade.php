...
<x-inline-create-dropdown dropdown-class="w-80 p-4">
    <x-slot:trigger>
        ...
        <span
            ...
            x-text="{{ $model }} ? (new Date({{ $model }}).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })) : 'Not set'"
        ></span>
    </x-slot:trigger>
