...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE recurring_events SET start_datetime = start_date, end_datetime = end_date WHERE start_date IS NOT NULL');
    ...
    public function down(): void
    {
        ...
        DB::statement('UPDATE recurring_events SET start_date = DATE(start_datetime), end_date = DATE(end_datetime) WHERE start_datetime IS NOT NULL');
